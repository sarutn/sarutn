  ...
  L.Control.Zoominfo = (function () {
    ...
    var Zoominfo = L.Control.extend({
      ...
      _createUI: function () {
        ...
        //nut
        $(ui.wrap).attr('title', 'ระยะซูมแผนที่');
      ...
      _createZoomBtn: function (zoomDir, end, container) {
        ...
        //nut
        if(zoomDir == 'in'){
          link.title = 'ซูมแผนที่ ' + 'เข้า';
        }
        else if(zoomDir == 'out'){
          link.title = 'ซูมแผนที่ ' + 'ออก';
        }
        else{
          link.title = 'ซูมแผนที่ ' + zoomDir;
        }
        //nut
      ...
      _updateInfoValue: function () {
        ...
        this._ui.info.innerHTML = '<strong >'+ parseFloat(this._map.getZoom()).toFixed(2) + '</strong>';
        if(Number(this._map.getZoom()) >=10){
          $('div.leaflet-control-zoominfo-info').css('margin-left','-18px');
        }
        else{
          $('div.leaflet-control-zoominfo-info').css('margin-left','-14px');
        }
